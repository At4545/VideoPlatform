  ...
  return (
    ...
    <div className='flex flex-wrap items-center gap-5 w-full'>
      ...
      <div id="collapseMenu"
        ...
        <div className=' pl-40 flex lg:ml-auto max-lg:w-full'>
        <div
    ...
    <div className='flex justify-end  items-center gap-7'>
        ...
        <div className="avatar">
            <div className="w-12 rounded">
                <img className='rounded-xl h-[48px] w-[48px] object-contain' src={avatar?avatar:"https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp"} />
             </div>
        </div>
    </div>
  </header>
